...
namespace Strings
{
     class Program
     {
          static void Main(string[] args)
          {
               ...
               //*format a string of numbers, phone, ssn, etc.  **processes right to left
               ...
               */
               ...
               /*
               //*using StringBuilder method class to improve performance 
                    (preferred for a lot of string concatenation)
               ...
               */
               ...
               string myString = "  You do what you KNOW how to do," +
                    "but when you know better you DO better.  ";
              
               string myPrintString = "  You do what you KNOW how to do," +
                    "but when you know better you DO better.";
               ...
               //*print the length before, trims white space and display length after
